...
export function Badge({
  ...
  const colorVariants = {
    blue: {
      ...
      outlineSoft: 'border border-blue-600 text-blue-600 bg-blue-500/5'
    },
    green: {
      solid: 'bg-green-600 text-white',
      outline: 'border border-green-600 text-green-600',
      outlineSoft: 'border border-green-600 text-green-600 bg-green-500/5'
    },
    red: {
      solid: 'bg-red-600 text-white',
      outline: 'border border-red-600 text-red-600',
      outlineSoft: 'border border-red-600 text-red-600 bg-red-500/5'
    },
    yellow: {
      solid: 'bg-yellow-500 text-white',
      outline: 'border border-yellow-500 text-yellow-500',
      outlineSoft: 'border border-yellow-500 text-yellow-600 bg-yellow-400/10'
    },
    gray: {
      solid: 'bg-gray-600 text-white',
      outline: 'border border-gray-600 text-gray-600',
      outlineSoft: 'border border-gray-600 text-gray-700 bg-gray-500/5'
    },
    black: {
      solid: 'bg-black text-white',
      outline: 'border border-black text-black',
      outlineSoft: 'border border-black text-black bg-black/5'
    },
    white: {
      solid: 'bg-white text-black',
      outline: 'border border-white text-white',
      outlineSoft: 'border border-white text-white/90 bg-white/25'
    },
    rose: {
      solid: 'bg-rose-500 text-white',
      outline: 'border border-rose-500 text-rose-500',
      outlineSoft: 'border border-rose-500 text-rose-600 bg-rose-500/5'
    }
  }
