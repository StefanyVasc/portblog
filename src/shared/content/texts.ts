export const texts = {
  ...
  home: {
    ...
    reading: {
      ...
      viewBookcase: 'ver estante',
      empty: 'nenhuma leitura registrada por enquanto.',
      tags: {
  ...
  bookcase: {
    ...
    history: 'histórico da estante',
    viewHistory: 'ver histórico',
    backToBookcase: 'voltar para estante',
    historyIntro: 'arquivo das leituras registradas, organizado por ano e mês.',
